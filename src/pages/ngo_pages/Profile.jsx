...
import CampaignCard from "../../components/Ngo-Components/CampaignCard";
...
function Profile() {
  ...
  return (
    <div className="bg-[#f6f6f6] w-full h-[90vh] overflow-y-auto ">
      {showUpdateForm
        ? <ProfileEdit setShowUpdateForm={setShowUpdateForm} />
        : <div>
            <section
            ...
            />
            <section className="h-[700px] max-w-[1200px] bg-green-40 mx-auto -translate-y-24 rounded-xl">
              <section className="w-full md:h-[180px] bg-white rounded-xl p-4">
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="w-[130px] h-8 bg-tempColor mr-2 rounded-md text-white font-medium text-sm hover:bg-violetLight"
                  >
                    Edit
                  </button>
                </div>
